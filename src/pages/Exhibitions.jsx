                ...
                <CardContent className="p-0">
                  ...
                  <div className="p-5">
                   <div className="flex items-center gap-4">
                     ...
                     {/* Middle: photo */}
                     <div
                       className="flex-shrink-0 w-24 h-24 rounded-xl overflow-hidden border-2 border-dashed border-gray-200 flex items-center justify-center bg-gray-50 relative cursor-pointer hover:border-blue-400 transition-all mr-8"
