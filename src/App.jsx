...
const AuthenticatedApp = () => {
  ...
  // ?install=true redirects mailshot visitors straight to the Add-to-Home-Screen guide
  useEffect(() => {
    const params = new URLSearchParams(window.location.search);
    if (params.get("install") === "true") {
      navigate("/AddToHomeScreen", { replace: true });
    }
  }, [navigate]);
  ...
  if (authError) {
    ...
    // For 'auth_required' and other errors, continue to show the app
    // The landing page will handle showing login options for unauthenticated users
  }
