  ...
  return (
    <div className="min-h-screen px-4 py-6 max-w-2xl mx-auto">
      ...
      <div className="text-center mb-8">
        ...
        <p className="text-gray-500 mt-2">Everything you need to know about CardScanner Pro — written in plain English, we promise!</p>
      </div>
      ...
      {tab === 0 && (
        <div className="space-y-3">
          ...
          <HelpSection icon="📧" title="How do I send a Thank You email?">
            ...
            <p className="mt-2">The email is sent from your CardScanner Pro account and includes your name, so it feels personal — not automated!</p>
          </HelpSection>
      ...
      {tab === 1 && (
        <div className="space-y-3">
          <HelpSection icon="🧭" title="What is the Discover section?">
            <p>The <strong>Discover</strong> section is the community side of CardScanner Pro — completely separate from your private scanning.</p>
            ...
            <p className="mt-2">Other CardScanner Pro users share their favourite places, and you can browse and benefit from their recommendations!</p>
          </HelpSection>
          ...
          <HelpSection icon="🌍" title="Public vs Private places — what's the difference?">
            ...
            <ul className="list-disc pl-5 space-y-1 mt-2">
              ...
              <li><strong>Public (on)</strong> — Your recommendation appears in the Discover section for all CardScanner Pro users to benefit from.</li>
            </ul>
        ...
        <div>
          <div className="text-center mb-6">
            ...
            <p className="text-gray-500 text-sm mt-1">
              Good, bad, or "I have no idea what I'm doing" — we want to know. Every piece of feedback helps make CardScanner Pro better for everyone.
            </p>
          </div>
          <FeedbackForm />
        </div>
